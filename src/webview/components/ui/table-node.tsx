  ...
  function TableElement({
    ...
    const content = (
      <PlateElement
        ...
        style={{ maxWidth: 'calc(100% - 24px)', paddingLeft: marginLeft }}
      >
        <div className="group/table relative w-fit">
          <table
            className={cn(
              'mr-0 ml-px table h-px w-full table-auto border-collapse',
...
function TableFloatingToolbar({
  ...
  return (
    ...
    >
      ...
      >
        <Toolbar
          className="scrollbar-hide !w-fit max-w-[80vw] flex-row justify-start gap-0 overflow-x-auto rounded-md border bg-popover p-0.5 shadow-md print:hidden"
          contentEditable={false}
        >
          <ToolbarGroup>
