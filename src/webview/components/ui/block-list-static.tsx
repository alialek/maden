...
function TodoMarkerStatic(props: SlateRenderElementProps) {
  ...
  return (
    <div contentEditable={false}>
      <button
        className={cn(
          'maden-task-checkbox peer -left-6 pointer-events-none absolute top-1 size-4 shrink-0 rounded-sm border bg-background ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 data-[state=checked]:bg-primary data-[state=checked]:text-primary-foreground',
          props.className
        )}
